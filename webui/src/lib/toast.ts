...
export const show_info = (msg: string, duration = 1000) => {
  toast.push(msg, {
    duration,
    theme: { ...default_theme }
  })
...
export const show_success = (msg: string, duration = 1000) => {
  toast.push(msg, {
    duration,
...
export const show_error = (msg: string, duration = 1000) => {
  toast.push(msg, {
    duration,
...
export const show_warning = (msg: string, duration = 1000) => {
  toast.push(msg, {
    duration,
...
export const show_toast = (msg: string, type: ToastType = "success", duration = 1000) => {
